...
namespace Farm.BaseController.CommunicationMessage
{
    ...
    public class CheckProcess : MessageBase
    {
        ...
        public bool IsInitModule { get; set; }
    }
    ...
    /// </summary>
    public class ProcessStatus : ResultMessageBase
    {
        ...
        public bool InitModule { get; set; }
        public bool IsName(string name) => string.CompareOrdinal(name, Name) == 0;
